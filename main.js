...
__export(main_exports, {
  count_inlinks: () => count_inlinks,
  default: () => gamification,
  getFileCountMap: () => getFileCountMap,
  getFileMap: () => getFileMap,
  getNumberOfOutlinks: () => getNumberOfOutlinks
});
...
You received an initialisation Booster aktiv for your first level ups. Game on!`).open();
  ...
  async getCreationTime(file) {
    const filePath = path.join(this.app.vault.getResourcePath(file));
